...
Routes:
    ...
    /states/<id>: display HTML page displaying the given state with <id>.i
    /hbnb_filters: Display HBnB HTML Filter
"""
...
def hbnb_filters():
    """
    Displays HTML page based on filter.
    States are sorted by name.
    """
    states = storage.all("State")
    states = storage.all("Amenity")
    return render_template("10-hbnb_filters.html",
                           state=states, amenities=amenities)
